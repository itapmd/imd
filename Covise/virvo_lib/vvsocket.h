...
// Funcionality:        Header file for vvsocket.cpp
...
protected:      
        ...
        ErrorType write_timeo(uchar*, size_t);
        ErrorType read_nontimeo(uchar*, size_t);
        ErrorType write_nontimeo(uchar*, size_t);      
