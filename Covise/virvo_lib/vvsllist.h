...
*/
template<class T> void vvSLList<T>::setDeleteData(bool newState)
{
...
*/
template<class T> void vvSLList<T>::setDeleteDataAll(bool newState)
{
  vvSLNode<T>* tmp = head;
...
*/
template<class T> void vvSLList<T>::append(const T& x, bool dd)
{
...
/** Insert the new element after the current element.
  ...
  @param dd true = delete data when list element is removed (defaults to true)
*/
template<class T> void vvSLList<T>::insertAfter(const T& x, bool dd)
{
  vvSLNode<T>* newNode = new vvSLNode<T>(dd);
...
/** Insert the new element before the current element.
  ...
  @param dd true = delete data when list element is removed (defaults to true)
*/
template<class T> void vvSLList<T>::insertBefore(const T& x, bool dd)
{
  vvSLNode<T>* newNode = new vvSLNode<T>(dd);
  vvSLNode<T>* tmp;
