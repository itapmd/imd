...
main()
{
  ...
  do {
    ...
    switch (ch) {
    case '0' : radius*=1.05;draw_scene(scene_type);break;
    case '.' : radius/=1.05;draw_scene(scene_type);break;
    ...
    case 'k' : if (kin) kin=0; else kin=1;draw_scene(scene_type);break;
